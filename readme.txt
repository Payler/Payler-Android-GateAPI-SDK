...
Библиотека проверяет публичный ключ SSL-сертификата на сервере Payler.  Это
...
v1.2.0:
  ...
  1. Обновленн пиннинг сертификата
  
v1.1.0:

  1. Добавлена поддержка рекуррентных платежей.

v1.0.3:

  1. Сделано правильное исправление ошибки со статусами платежа.
  2. Добавлена поддержка нового SSL сертификата.
